 ...
 *
 * This class creates Giropay payment method.
 *
...
class Giropay extends Ideal{
   ...
   public function get_default_title(){
      return __('Adyen - Giropay', 'woosa-adyen');
   }
   ...
   public function get_default_description(){
      return sprintf(__('In order to support recurring payments with Giropay you have to enable SEPA Direct Debit first. %s', 'woosa-adyen'), '<br/>'.$this->show_supported_country());
   }
