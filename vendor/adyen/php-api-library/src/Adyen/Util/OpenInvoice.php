 ...
 *
 */
namespace Woosa\Adyen\Adyen\Util;
...
class OpenInvoice
{
     ...
     * @var array
     */
    private static $openInvoicePaymentMethods = array(self::AFTERPAY_PAYMENT_METHOD, self::AFTERPAY_B2B_PAYMENT_METHOD, self::AFTERPAY_DEFAULT_PAYMENT_METHOD, self::AFTERPAY_DIRECTDEBIT_PAYMENT_METHOD, self::AFTERPAYTOUCH, self::AFTERPAYTOUCH_AU, self::AFTERPAYTOUCH_CA, self::AFTERPAYTOUCH_NZ, self::AFTERPAYTOUCH_US, self::RATEPAY, self::RATEPAY_DIRECTDEBIT_PAYMENT_METHOD, self::KLARNA_PAYMENT_METHOD, self::KLARNA_B2B_PAYMENT_METHOD, self::KLARNA_PAYNOW_PAYMENT_METHOD, self::KLARNA_ACCOUNT_PAYMENT_METHOD, self::AFFIRM, self::CLEARPAY, self::FACILYPAY, self::FACILYPAY_10X, self::FACILYPAY_10X_MERCHANT_PAYS, self::FACILYPAY_10X_WITHFEES, self::FACILYPAY_12X, self::FACILYPAY_12X_MERCHANT_PAYS, self::FACILYPAY_12X_WITHFEES, self::FACILYPAY_3X, self::FACILYPAY_3X_MERCHANT_PAYS, self::FACILYPAY_3X_WITHFEES, self::FACILYPAY_4X, self::FACILYPAY_4X_MERCHANT_PAYS, self::FACILYPAY_4X_WITHFEES, self::FACILYPAY_6X, self::FACILYPAY_6X_MERCHANT_PAYS, self::FACILYPAY_6X_WITHFEES, self::FACILYPAY_FR);
    /**
     * List of after pay touch payment methods
     *
     * @var array
     */
    private static $afterPayTouchPaymentMethods = array(self::AFTERPAYTOUCH, self::AFTERPAYTOUCH_AU, self::AFTERPAYTOUCH_CA, self::AFTERPAYTOUCH_NZ, self::AFTERPAYTOUCH_US);
    /**
    ...
    {
        if (\mb_substr($paymentMethod, 0, 6) == self::KLARNA_PAYMENT_METHOD || \mb_substr($paymentMethod, 0, 8) == self::AFTERPAY_PAYMENT_METHOD) {
            return 'High';
        }
        return 'None';
    }
