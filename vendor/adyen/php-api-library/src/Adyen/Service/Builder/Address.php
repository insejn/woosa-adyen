...
class Address
{
     ...
     * @return array
     */
    public function buildBillingAddress($street = '', $houseNumberOrName = '', $postalCode = '', $city = '', $stateOrProvince = '', $country = '', $request = array())
    {
        return $this->buildAddress(self::$addressTypeBilling, $street, $houseNumberOrName, $postalCode, $city, $stateOrProvince, $country, $request);
    }
    /**
     * @param string $street
     * @param string $houseNumberOrName
     ...
     * @return array
     */
    public function buildDeliveryAddress($street = '', $houseNumberOrName = '', $postalCode = '', $city = '', $stateOrProvince = '', $country = '', $request = array())
    {
        return $this->buildAddress(self::$addressTypeDelivery, $street, $houseNumberOrName, $postalCode, $city, $stateOrProvince, $country, $request);
    }
    /**
     ...
     * @return array
     */
    private function buildAddress($addressType, $street, $houseNumberOrName, $postalCode, $city, $stateOrProvince, $country, $request)
    {
        $address = array();
        if (!empty($street)) {
