...
class Referral
{
    ...
    {
        return array('referralContainer' => array('referral' => $referral));
    }
    /**
    ...
    {
        $data = array('addressReferrals' => array());
        foreach ($addresses as $address) {
            $data['addressReferrals'][] = array('shopperAddress' => $address);
        }
        return $data;
    }
    /**
    ...
    {
        return array('paymentReferenceReferral' => array('pspReference' => $pspReference, 'referralTypes' => $referralTypes));
    }
    /**
     * @param string $accountCode
     * @param string $referralType
    ...
    {
        $data = array('accountCode' => $accountCode, 'referralType' => $referralType, 'action' => $action);
        if (!empty($reason)) {
            $data['reason'] = $reason;
        }
        return $data;
