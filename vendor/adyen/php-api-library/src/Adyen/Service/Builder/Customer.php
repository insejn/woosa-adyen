 ...
 *
 */
namespace Woosa\Adyen\Adyen\Service\Builder;
...
class Customer
{
     ...
     * @return array
     */
    public function buildCustomerData($isOpenInvoicePaymentMethod, $email = '', $phoneNumber = '', $gender = '', $dateOfBirth = '', $firstName = '', $lastName = '', $countryCode = '', $localeCode = '', $shopperIp = '', $customerId = 0, $request = array())
    {
        ...
        if ($isOpenInvoicePaymentMethod) {
            $request = $this->buildCustomerDataForOpenInvoicePaymentMethod($email, $phoneNumber, $gender, $dateOfBirth, $firstName, $lastName, $request);
        } else {
            $request = $this->buildCustomerDataForNonOpenInvoicePaymentMethod($email, $phoneNumber, $gender, $dateOfBirth, $firstName, $lastName, $request);
        }
     ...
     * @return array
     */
    private function buildCustomerDataForOpenInvoicePaymentMethod($email, $telephoneNumber, $gender, $dateOfBirth, $firstName, $lastName, $request = array())
    {
     ...
     * @return array
     */
    private function buildCustomerDataForNonOpenInvoicePaymentMethod($email, $telephoneNumber, $gender, $dateOfBirth, $firstName, $lastName, $request = array())
    {
        if (!empty($email)) {
