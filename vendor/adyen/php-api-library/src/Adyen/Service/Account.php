...
class Account extends \Woosa\Adyen\Adyen\Service
{
    /**
    ...
    public function __construct(\Woosa\Adyen\Adyen\Client $client)
    {
        ...
        $this->createAccount = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\CreateAccount($this);
        $this->createAccountHolder = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\CreateAccountHolder($this);
        $this->updateAccountHolder = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\UpdateAccountHolder($this);
        $this->getAccountHolder = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\GetAccountHolder($this);
        $this->updateAccount = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\UpdateAccount($this);
        $this->uploadDocument = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\UploadDocument($this);
        $this->getUploadedDocuments = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\GetUploadedDocuments($this);
        $this->updateAccountHolderState = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\UpdateAccountHolderState($this);
        $this->deleteBankAccounts = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\DeleteBankAccounts($this);
        $this->deleteShareholders = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\DeleteShareholders($this);
        $this->closeAccount = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\CloseAccount($this);
        $this->closeAccountHolder = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\CloseAccountHolder($this);
        $this->suspendAccountHolder = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\SuspendAccountHolder($this);
        $this->unSuspendAccountHolder = new \Woosa\Adyen\Adyen\Service\ResourceModel\Account\UnSuspendAccountHolder($this);
    }
    /**
     * @param $params
     * @return mixed
