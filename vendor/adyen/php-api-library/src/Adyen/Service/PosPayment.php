...
class PosPayment extends \Woosa\Adyen\Adyen\ApiKeyAuthenticatedService
{
    /**
    ...
    public function __construct(\Woosa\Adyen\Adyen\Client $client)
    {
        ...
        $this->runTenderSync = new \Woosa\Adyen\Adyen\Service\ResourceModel\Payment\TerminalCloudAPI($this, \false);
        $this->runTenderAsync = new \Woosa\Adyen\Adyen\Service\ResourceModel\Payment\TerminalCloudAPI($this, \true);
        $this->connectedTerminals = new \Woosa\Adyen\Adyen\Service\ResourceModel\Payment\ConnectedTerminals($this);
    }
    /**
     * @param $params
     * @return mixed
