...
class Payment extends \Woosa\Adyen\Adyen\Service
{
    /**
    ...
    public function __construct(\Woosa\Adyen\Adyen\Client $client)
    {
        ...
        $this->authorise = new \Woosa\Adyen\Adyen\Service\ResourceModel\Payment\Authorise($this);
        $this->authorise3D = new \Woosa\Adyen\Adyen\Service\ResourceModel\Payment\Authorise3D($this);
        $this->authorise3DS2 = new \Woosa\Adyen\Adyen\Service\ResourceModel\Payment\Authorise3DS2($this);
    }
    /**
     * @param $params
