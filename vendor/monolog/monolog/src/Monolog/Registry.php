...
class Registry
{
     ...
     */
    public static function addLogger(\Woosa\Adyen\Monolog\Logger $logger, ?string $name = null, bool $overwrite = \false)
    {
    ...
    {
        if ($logger instanceof \Woosa\Adyen\Monolog\Logger) {
     ...
     */
    public static function getInstance($name) : \Woosa\Adyen\Monolog\Logger
    {
