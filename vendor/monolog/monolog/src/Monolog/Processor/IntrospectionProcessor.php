 ...
 */
namespace Woosa\Adyen\Monolog\Processor;
 ...
 */
class IntrospectionProcessor implements \Woosa\Adyen\Monolog\Processor\ProcessorInterface
{
    private $level;
     ...
     */
    public function __construct($level = \Woosa\Adyen\Monolog\Logger::DEBUG, array $skipClassesPartials = [], int $skipStackFramesCount = 0)
    {
        $this->level = \Woosa\Adyen\Monolog\Logger::toMonologLevel($level);
