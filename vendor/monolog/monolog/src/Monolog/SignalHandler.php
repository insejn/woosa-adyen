...
class SignalHandler
{
    ...
    public function registerSignalHandler($signo, $level = \Woosa\Adyen\Psr\Log\LogLevel::CRITICAL, bool $callPrevious = \true, bool $restartSyscalls = \true, ?bool $async = \true) : self
    {
    ...
    public function handleSignal($signo, array $siginfo = null) : void
    {
        ...
        $level = $this->signalLevelMap[$signo] ?? \Woosa\Adyen\Psr\Log\LogLevel::CRITICAL;
