 ...
 */
class SocketHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(string $connectionString, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
