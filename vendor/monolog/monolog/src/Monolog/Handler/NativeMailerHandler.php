 ...
 */
class NativeMailerHandler extends \Woosa\Adyen\Monolog\Handler\MailHandler
{
    /**
     ...
     */
    public function __construct($to, string $subject, string $from, $level = \Woosa\Adyen\Monolog\Logger::ERROR, bool $bubble = \true, int $maxColumnWidth = 70)
    {
    ...
    protected function send(string $content, array $records) : void
    {
        ...
        if ($records) {
            $subjectFormatter = new \Woosa\Adyen\Monolog\Formatter\LineFormatter($this->subject);
