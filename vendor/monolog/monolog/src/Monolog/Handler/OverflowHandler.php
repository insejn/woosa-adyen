 ...
 */
class OverflowHandler extends \Woosa\Adyen\Monolog\Handler\AbstractHandler implements \Woosa\Adyen\Monolog\Handler\FormattableHandlerInterface
{
    /** @var HandlerInterface */
    private $handler;
    /** @var int[] */
    private $thresholdMap = [\Woosa\Adyen\Monolog\Logger::DEBUG => 0, \Woosa\Adyen\Monolog\Logger::INFO => 0, \Woosa\Adyen\Monolog\Logger::NOTICE => 0, \Woosa\Adyen\Monolog\Logger::WARNING => 0, \Woosa\Adyen\Monolog\Logger::ERROR => 0, \Woosa\Adyen\Monolog\Logger::CRITICAL => 0, \Woosa\Adyen\Monolog\Logger::ALERT => 0, \Woosa\Adyen\Monolog\Logger::EMERGENCY => 0];
    /**
     ...
     * @param bool             $bubble
     */
    public function __construct(\Woosa\Adyen\Monolog\Handler\HandlerInterface $handler, array $thresholdMap = [], $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
