 ...
 */
class RedisPubSubHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $channelKey;
    /**
     ...
     */
    public function __construct($redis, string $key, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
