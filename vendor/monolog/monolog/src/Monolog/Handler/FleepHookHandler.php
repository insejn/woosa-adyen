 ...
 */
class FleepHookHandler extends \Woosa\Adyen\Monolog\Handler\SocketHandler
{
    ...
    public function __construct(string $token, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
        if (!\extension_loaded('openssl')) {
            throw new \Woosa\Adyen\Monolog\Handler\MissingExtensionException('The OpenSSL PHP extension is required to use the FleepHookHandler');
        }
        $this->token = $token;
    ...
    {
        return new \Woosa\Adyen\Monolog\Formatter\LineFormatter(null, null, \true, \true);
    }
    /**
