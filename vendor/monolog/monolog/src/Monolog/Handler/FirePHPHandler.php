...
use Woosa\Adyen\Monolog\Formatter\WildfireFormatter;
 ...
 */
class FirePHPHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \Woosa\Adyen\Monolog\Formatter\WildfireFormatter();
    }
    /**
