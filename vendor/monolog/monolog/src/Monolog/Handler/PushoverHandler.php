 ...
 */
class PushoverHandler extends \Woosa\Adyen\Monolog\Handler\SocketHandler
{
    private $token;
    private $users;
    private $title;
     ...
     */
    public function __construct(string $token, $users, ?string $title = null, $level = \Woosa\Adyen\Monolog\Logger::CRITICAL, bool $bubble = \true, bool $useSSL = \true, $highPriorityLevel = \Woosa\Adyen\Monolog\Logger::CRITICAL, $emergencyLevel = \Woosa\Adyen\Monolog\Logger::EMERGENCY, int $retry = 30, int $expire = 25200)
    {
        ...
        $this->highPriorityLevel = \Woosa\Adyen\Monolog\Logger::toMonologLevel($highPriorityLevel);
        $this->emergencyLevel = \Woosa\Adyen\Monolog\Logger::toMonologLevel($emergencyLevel);
        $this->retry = $retry;
        $this->expire = $expire;
    }
    ...
    private function buildContent(array $record) : string
    {
        ...
        $message = \Woosa\Adyen\Monolog\Utils::substr($message, 0, $maxMessageLength);
    ...
    {
        $this->highPriorityLevel = \Woosa\Adyen\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    public function setEmergencyLevel($value) : self
    {
        $this->emergencyLevel = \Woosa\Adyen\Monolog\Logger::toMonologLevel($value);
        return $this;
    }
    /**
