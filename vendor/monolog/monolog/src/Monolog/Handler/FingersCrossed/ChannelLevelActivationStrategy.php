 ...
 */
class ChannelLevelActivationStrategy implements \Woosa\Adyen\Monolog\Handler\FingersCrossed\ActivationStrategyInterface
{
    /**
     * @var int
     */
    ...
    {
        $this->defaultActionLevel = \Woosa\Adyen\Monolog\Logger::toMonologLevel($defaultActionLevel);
