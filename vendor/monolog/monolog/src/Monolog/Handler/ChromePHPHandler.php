...
use Woosa\Adyen\Monolog\Formatter\ChromePHPFormatter;
 ...
 */
class ChromePHPHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \Woosa\Adyen\Monolog\Formatter\ChromePHPFormatter();
    }
    /**
    ...
    protected function send() : void
    {
        ...
        if (\strlen($data) > 3 * 1024) {
            self::$overflowed = \true;
            $record = ['message' => 'Incomplete logs, chrome header size limit reached', 'context' => [], 'level' => \Woosa\Adyen\Monolog\Logger::WARNING, 'level_name' => \Woosa\Adyen\Monolog\Logger::getLevelName(\Woosa\Adyen\Monolog\Logger::WARNING), 'channel' => 'monolog', 'datetime' => new \DateTimeImmutable(), 'extra' => []];
