 ...
 */
class CouchDBHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    private $options;
    public function __construct(array $options = [], $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true)
    {
