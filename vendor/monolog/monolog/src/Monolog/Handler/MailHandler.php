...
use Woosa\Adyen\Monolog\Formatter\HtmlFormatter;
/**
 * Base class for all mail handlers
 *
 * @author Gyula Sallai
 */
abstract class MailHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return new \Woosa\Adyen\Monolog\Formatter\HtmlFormatter();
    }
}
