 ...
 */
class RedisHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    private $redisClient;
    private $redisKey;
    protected $capSize;
     ...
     */
    public function __construct($redis, string $key, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true, int $capSize = 0)
    {
        if (!($redis instanceof \Woosa\Adyen\Predis\Client || $redis instanceof \Redis)) {
