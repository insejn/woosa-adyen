 ...
 */
class TestHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    protected $records = [];
    ...
    {
        return isset($this->recordsByLevel[\Woosa\Adyen\Monolog\Logger::toMonologLevel($level)]);
    }
    /**
    ...
    {
        $level = \Woosa\Adyen\Monolog\Logger::toMonologLevel($level);
