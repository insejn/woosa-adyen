...
use Woosa\Adyen\Aws\Sdk;
use Woosa\Adyen\Aws\DynamoDb\DynamoDbClient;
use Woosa\Adyen\Monolog\Formatter\FormatterInterface;
use Woosa\Adyen\Aws\DynamoDb\Marshaler;
use Woosa\Adyen\Monolog\Formatter\ScalarFormatter;
 ...
 */
class DynamoDbHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
    ...
    {
        return new \Woosa\Adyen\Monolog\Formatter\ScalarFormatter(self::DATE_FORMAT);
    }
}
