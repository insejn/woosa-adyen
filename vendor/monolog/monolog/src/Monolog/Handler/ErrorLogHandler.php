 ...
 */
class ErrorLogHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
     ...
     */
    public function __construct(int $messageType = self::OPERATING_SYSTEM, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true, bool $expandNewlines = \false)
    {
    ...
    {
        return new \Woosa\Adyen\Monolog\Formatter\LineFormatter('[%datetime%] %channel%.%level_name%: %message% %context% %extra%');
    }
    /**
     * {@inheritdoc}
     */
