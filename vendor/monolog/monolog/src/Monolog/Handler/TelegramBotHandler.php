 ...
 */
class TelegramBotHandler extends \Woosa\Adyen\Monolog\Handler\AbstractProcessingHandler
{
     ...
     * @inheritDoc
     */
    public function __construct(string $apiKey, string $channel, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true, string $parseMode = null, bool $disableWebPagePreview = null, bool $disableNotification = null)
    {
    ...
    protected function send(string $message) : void
    {
        ...
        $result = \Woosa\Adyen\Monolog\Handler\Curl\Util::execute($ch);
