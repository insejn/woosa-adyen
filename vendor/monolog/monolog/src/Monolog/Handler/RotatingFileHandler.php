 ...
 */
class RotatingFileHandler extends \Woosa\Adyen\Monolog\Handler\StreamHandler
{
     ...
     */
    public function __construct(string $filename, int $maxFiles = 0, $level = \Woosa\Adyen\Monolog\Logger::DEBUG, bool $bubble = \true, ?int $filePermission = null, bool $useLocking = \false)
    {
        $this->filename = \Woosa\Adyen\Monolog\Utils::canonicalizePath($filename);
