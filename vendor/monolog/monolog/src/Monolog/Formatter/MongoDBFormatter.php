 ...
 */
class MongoDBFormatter implements \Woosa\Adyen\Monolog\Formatter\FormatterInterface
{
    ...
    protected function formatObject($value, int $nestingLevel)
    {
        ...
        $objectVars['class'] = \Woosa\Adyen\Monolog\Utils::getClass($value);
        return $this->formatArray($objectVars, $nestingLevel);
    }
    protected function formatException(\Throwable $exception, int $nestingLevel)
    {
        $formattedException = ['class' => \Woosa\Adyen\Monolog\Utils::getClass($exception), 'message' => $exception->getMessage(), 'code' => (int) $exception->getCode(), 'file' => $exception->getFile() . ':' . $exception->getLine()];
