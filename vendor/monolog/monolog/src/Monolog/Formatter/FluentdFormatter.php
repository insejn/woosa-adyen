 ...
 */
class FluentdFormatter implements \Woosa\Adyen\Monolog\Formatter\FormatterInterface
{
    /**
    ...
    public function format(array $record) : string
    {
        ...
        return \Woosa\Adyen\Monolog\Utils::jsonEncode([$tag, $record['datetime']->getTimestamp(), $message]);
    }
