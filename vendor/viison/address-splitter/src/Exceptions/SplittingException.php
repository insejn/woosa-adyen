...
namespace Woosa\Adyen\VIISON\AddressSplitter\Exceptions;
...
{
    const CODE_ADDRESS_SPLITTING_ERROR = 0x1;
    const CODE_HOUSE_NUMBER_SPLITTING_ERROR = 0x2;
    const CODE_UNKNOWN_ERROR = 0xff;
    /**
     * @var array Predefined error message
     */
    private static $errorMessages = array(self::CODE_ADDRESS_SPLITTING_ERROR => 'Address \'%s\' could not be splitted into street name and house number.', self::CODE_HOUSE_NUMBER_SPLITTING_ERROR => 'House number \'%s\' could not be splitted into base and extension.', self::CODE_UNKNOWN_ERROR => 'Unknown error');
    /**
